...
const Navbar = () => {
    ...
    return (
        <>
        <div className="bg-zinc-200 md:drop-shadow-xl mt-1 h-[80px] flex justify-around z-10 animNav">
            <div className="mt-4">
                <h1 className='text-2xl mt-1 font-bold md:text-3xl'><Link to="/">Bilol_Dev</Link></h1>
            </div>
            <div className="hidden md:block mt-6">
                <ul className='flex justify-between'>
                    <li className='pr-5 text-lg cursor-pointer hover:text-indigo-500'><Link to="/">Home</Link></li>
                    <li className='pr-5 text-lg cursor-pointer hover:text-indigo-500'><Link to="/my_images">My Images</Link></li>
                    <li className='pr-5 text-lg cursor-pointer hover:text-indigo-500'><Link to="/about">About</Link></li>
                    <div className="relative bottom-3">
                        <button className='text-black py-3 px-6 ml-2'><Link to="/login">Sign In</Link></button>
                        <button className='text-black py-3 px-6 transition bg-indigo-500 ml-5 text-white'><Link to="/login">Sign Up</Link></button>
                    </div>
                </ul>
            </div>
            {/* DropDown Menu */}
                ...
                { isOpen && 
                    <ul className='block ml-3 mr-3 md:hidden'>
                        ...
                        <div className="mt-2">
                            ...
                            <button className='text-black block w-full py-3 px-6 transition bg-indigo-500 mt-3 mb-5'><Link to="/login">Sign Up</Link></button>
                        </div>
                    </ul>
                }
            </div>
