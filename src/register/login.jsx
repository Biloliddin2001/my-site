    ...
    return (
        <>  
            ...
            <div className="login bg-zinc-100 md:p-10 md:flex md:w-[1140px] md:mt-10 md:mb-0 md:mr-[60px] md:ml-[60px] md:justify-around md:rounded-3xl drop-shadow-2xl
                ...
                <div className="login_create border-indigo-600 border-r-2 border-l-2 hover:border-l-0 
                    rounded-3xl hover:border-b-2 hover:border-t-2 hover:border-r-0 
                    md:w-[600px] mt-5 mb-5 flex md:items-center justify-center md:mr-5 
